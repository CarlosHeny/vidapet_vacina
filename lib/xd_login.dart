      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 174.0, end: -5.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -29.6, end: -82.9),
                  Pin(start: -184.4, end: -173.6),
                ...
                Pinned.fromPins(
                  Pin(size: 31.0, start: 42.0),
                  Pin(size: 17.0, middle: 0.8153),
                  child: Text(
                    'saltar',
                    style: TextStyle(
                ...
                Pinned.fromPins(
                  Pin(start: -33.2, end: -79.4),
                  Pin(start: -159.3, end: -198.7),
                  child: SvgPicture.string(
                    _svg_yjz7jx,
                    allowDrawingOutsideViewBox: true,
                    fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(start: -2.1, end: -1.3),
            Pin(size: 201.2, start: -3.9),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -204.7, end: -189.9),
                  Pin(start: -309.0, end: -381.8),
                  child: SvgPicture.string(
                    _svg_a4bt3v,
                    allowDrawingOutsideViewBox: true,
                    fit: BoxFit.fill,
                ...
                Pinned.fromPins(
                  Pin(start: -110.5, end: -205.2),
                  Pin(start: -319.9, end: -250.0),
                  child: SvgPicture.string(
                    _svg_l7yvlv,
                    allowDrawingOutsideViewBox: true,
                    fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 150.0, middle: 0.25),
            Pin(size: 19.0, middle: 0.4107),
            child: Text(
              'mauricio@divelement.io',
              style: TextStyle(
                fontFamily: 'Google Sans',
                fontSize: 14,
          ...
          Pinned.fromPins(
            Pin(size: 64.0, middle: 0.1886),
            Pin(size: 19.0, middle: 0.5225),
            child: Text(
              '***********',
              style: TextStyle(
                fontFamily: 'Google Sans',
          ...
          Pinned.fromPins(
            Pin(start: 42.0, end: 39.0),
            Pin(size: 54.0, middle: 0.6713),
            child: PageLink(
              links: [
                PageLinkInfo(
          ...
          Pinned.fromPins(
            Pin(size: 82.0, middle: 0.3464),
            Pin(size: 51.0, middle: 0.8205),
            child: Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 12.0, middle: 0.3731),
            Pin(size: 24.0, middle: 0.8105),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 183.0, middle: 0.5152),
            Pin(size: 17.0, middle: 0.7285),
            child: Text.rich(
              TextSpan(
                style: TextStyle(
                  fontFamily: 'Google Sans',
          ...
          Pinned.fromPins(
            Pin(size: 17.0, middle: 0.8287),
            Pin(size: 17.0, middle: 0.4109),
            child:
